...
export class ProductItemService {
  ...
  loadList(filter: PaginationParams): Observable<PaginatedResult<any>> {
    ...
    return this.http.get<PaginatedResult<any>>(this.baseUrl + 'products/items', {params});
  }


  loadForm(id: any) {
    return this.http.get(this.baseUrl + `products/items/${id}`);
  }

  save(value:any):Observable<any> {
    return this.http.post(this.baseUrl + `products/items/save`, value);
  }
}
